...
namespace Evolution.DAL
{
    ...
    public partial class SalesOrderHeaderTemp
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public SalesOrderHeaderTemp()
        {
        ...
        public bool ManualDWSet { get; set; }
        ...
        public Nullable<System.DateTimeOffset> OrderHoldExpiryDate { get; set; }
        ...
        public Nullable<System.DateTimeOffset> OARChangeDate { get; set; }
        public string WarehouseInstructions { get; set; }
        public bool IsMSQProblem { get; set; }
        public string EndUserName { get; set; }
        public bool IsOverrideMSQ { get; set; }
        public Nullable<int> OverrideApproverId { get; set; }
        public Nullable<System.DateTimeOffset> NextReviewDate { get; set; }
        public Nullable<int> FreightTermId { get; set; }
        public Nullable<int> CreditCardId { get; set; }
        public string WebsiteOrderNo { get; set; }
        public string WebsiteTransactionID { get; set; }
        public string SiteName { get; set; }
        public Nullable<decimal> FreightExGST { get; set; }
        public Nullable<decimal> FreightGST { get; set; }
        public bool IsProcessed { get; set; }
        public bool IsRetailSale { get; set; }
        public bool IsRetailHoldingOrder { get; set; }
        public string EDI_Department { get; set; }
        public string EDI_DCCode { get; set; }
        public string EDI_StoreNo { get; set; }
        ...
        public string EvidenceFilespec { get; set; }
        ...
        public virtual LOVItem LOVItem_FreightTerm { get; set; }
        public virtual LOVItem LOVItem_OrderType { get; set; }
        public virtual LOVItem LOVItem_ShippingMethod { get; set; }
        public virtual LOVItem LOVItem_Source { get; set; }
        public virtual MethodSigned MethodSigned { get; set; }
        public virtual SaleNextAction SaleNextAction { get; set; }
        ...
        public virtual User User_OverrideApprover { get; set; }
    }
}
