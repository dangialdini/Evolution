...
namespace Evolution.TaskProcessorTests {
    [TestClass]
    public partial class CleanupAllTestsTaskTests : BaseTest {
        [TestMethod]
        public void GetTaskNameTest() {
            var task = new CleanupAllTestsTask(db);
            string expected = TaskName.CleanupAllTests,
        ...
        public void DoProcessingTest() {
            ...
            string[] args = { TaskName.CleanupAllTests };
            app.Run(args);
        }
    }
}
